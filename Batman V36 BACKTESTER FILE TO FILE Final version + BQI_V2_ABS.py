...
# ================== CONFIG PROCESO ==================
NUM_RANDOM_FILES = 5     # Número de archivos CSV a procesar aleatoriamente del directorio DATA_DIR
...
K3_DELTA_MIN = 0.05          # Delta mínimo para K3 (10%)
K3_DELTA_MAX = 0.15           # Delta máximo para K3 (50%)
